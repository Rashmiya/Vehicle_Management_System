...
const SoldOutCarsCard = (props: any) => {
    ...
    <View>
      <TouchableOpacity style={styles.mainArea}>
        ...
        <View style={styles.detailsArea}>
          ...
          <View style={styles.detailsItem}>
            <Text style={styles.priceTxt}>LKR {props.data.price}</Text>
            <Text />
            <View style={styles.millageArea}>
              ...
              <Text style={styles.milTxt}> {props.data.mileage} Km</Text>
            </View>
          </View>
        </View>
      </TouchableOpacity>
...
export default SoldOutCarsCard;
